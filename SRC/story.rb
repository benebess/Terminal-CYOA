...
module Pt1ch1
    def self.text(name, pronoun)
        puts anim("#{name} pulls the lid off the manhole and fumbles for the ladder, 
...
module Pt1ch2
    def self.text(name, pronoun)
        puts anim("#{name} has never been one to back down, picking up the pace they run directly towards the figure, 
...
module Pt1ch3
    def self.text(name,pronoun)
        puts anim("Looking around,  #{name} see's a park to #{pronoun} left, 
...
module Pt2ch21
    def self.text(name, pronoun)
        puts anim("#{name} smiles at the old man, gesturing to #{pronoun} paper, and says 'Of course, I'm going the same way'. 
...
module Pt2ch22
    def self.text(name, pronoun)
        puts anim("The man watches you walk away, a sad look in his eyes. 
...
module Pt2ch23
    def self.text(name, pronoun)
        puts anim("The man nods, shoulders slumping, he walks wearily down the street towards the park. 
...
module Pt3ch31
    def self.text(name, pronoun)
        puts anim("#{name} fumbles down the street, blindly looking for a letter box or something to help find the place they search for. 
...
module Pt3ch32
    def self.text(name, pronoun)
        puts anim("#{name} remembers seeing an old tattered bag back in the park, it's a long shot but perhaps there is a flashlight in there. 
...
module Pt4ch42
    def self.text(name, pronoun)
        puts anim("#{name} decides not to listen to the man and kindly guides him down the street to the right. 
...
module Pt5ch51
    def self.text(name, pronoun)
        puts anim("Using the flashlight, #{name} peers down at the piece of paper. 
...
module Pt5ch52
    def self.text(name, pronoun)
        puts anim("As #{name} starts back towards the street, they stop and turn back to the old mans house...  
        ...
        puts Rainbow("-------------------------").lightcoral
        a = AsciiArt.new("/Users/bonepile/Desktop/BenedictePowell_T1A3/DOCS/genie.png")
